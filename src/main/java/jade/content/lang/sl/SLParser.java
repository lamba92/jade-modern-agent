...
class SLParser implements SLParserConstants {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("usage: SLParser SLLevel\\cn  where SLLevel can be 0 for SL0, 1 for SL1, 2 for SL2, 3 or more for full SL");
			System.exit(0);
		}
		...
		while (true) {
			...
			try {
				...
				System.out.println("\\cn\\cn RESULT of SLParser.Content()=\\cn"+resultEncoded);
				AbsContentElement result2 = codec.decode(resultEncoded);
				System.out.println("\\cn\\cn RESULT of SLCodec.decode(SLCodec.encode(SLParser.Content()))=\\cn"+codec.encode(result2));
	...
	final public AbsPrimitive Constant() throws ParseException {
		...
		case STRING_LITERAL2:
			...
			if (CaseInsensitiveString.equalsIgnoreCase(s, "true"))
				...
				if (  (CaseInsensitiveString.equalsIgnoreCase(s,"\\true\\"))
	...
	final public String String() throws ParseException {
		...
		case STRING_LITERAL2:
			...
			if (  (CaseInsensitiveString.equalsIgnoreCase(t.image,"\\ctrue\\c"))
					||(CaseInsensitiveString.equalsIgnoreCase(t.image,"\\cfalse\\c")) )
